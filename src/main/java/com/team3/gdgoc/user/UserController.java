...
import com.team3.gdgoc.schedule.ScheduleService;
...
public class UserController {
    ...
    public ApiResponse<MyInfoResponse> getMyInfo(@PathVariable String userIdentity,
        ...
        double processRatio = taskCheckStatusService.getTaskCompletionRateForUser(userId);
        // 임시데이터
        int ranking = 3;
        int totalUsers = 100;
...
//        );
        List<MonthlyProgressResponse> monthlyProgressResponses = scheduleService.getMonthlyProgress(userIdentity,  year,  month);
